...
| ------- | ------ | ----------- |
| [WASI 0.3](wasi-p3.md) | Release candidate | Native async support with `async func`, `stream<T>`, and `future<T>`; refactored WASI 0.2 interfaces |
...
| API Proposal                                                          | Repository                             |
| --------------------------------------------------------------------- | -------------------------------------- |
| [I/O][wasi-io] (removed in WASI 0.3)                                  | https://github.com/WebAssembly/wasi-io |
