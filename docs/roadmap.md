...
WASI 0.3.0 is currently in **release candidate** stage (`0.3.0-rc-2026-03-15`). WASI 0.3 support is available in [Wasmtime 43+](https://github.com/bytecodealliance/wasmtime) and [jco](https://github.com/bytecodealliance/jco).
